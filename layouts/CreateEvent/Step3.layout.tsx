      ...
      onSubmit={(e) => {
        ...
        if (formDetails.image && formDetails.slides.length >= 3) {
          ...
          toast({
            ...
            duration: 5000,
            description: "Add atleast 3 images in your event gallery",
            status: "error",
          });
        }
      }}
              ...
              <AspectRatio ratio={16 / 8} maxW="440px">
                <Dropzone
                  onDrop={async (acceptedFiles) => {
                    ...
                    let res: string = await uploadImage(data);
                    console.log(res);
                    setFormDetails({
                      ...formDetails,
                      image: res,
                      slides: [res, ...formDetails.slides],
                    });
                    setLoading(false);
                  }}
                >
                    ...
                    <Dropzone
                      onDrop={async (acceptedFiles) => {
                        ...
                        acceptedFiles.forEach(async (data, key) => {
                          ...
                          let res: string = await uploadImage(bytedata);
                          console.log(res);
                          setFormDetails({
                            ...formDetails,
