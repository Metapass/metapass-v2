      ...
      onSubmit={(e) => {
        ...
        if (formDetails.image && formDetails.slides.length >= 1) {
          ...
          toast({
            ...
            duration: 5000,
            description: 'Add atleast 1 images in your event gallery',
            status: 'error',
          });
        }
      }}
          ...
          <Box fontFamily='body' w='full'>
            <FormControl>
              ...
              <FormLabel
                ...
                pb='4'
              >
                Add a logo/image for the ticket of your event’s NFT.
              </FormLabel>
              {loading1 && (
                <Box position='relative' top='10' left='15' zIndex={9}>
                  <Spinner w='6' h='6' />
                </Box>
              )}
              {ticket ? (
                <Flex>
                  <Image src={ticket} width='md' alt='Ticket Image' />
                  <Button
                    onClick={() => {
                      setTicket(undefined);
                      formDetails.image = '';
                ...
                <AspectRatio ratio={16 / 8} maxW='440px'>
                  <Dropzone
                    onDrop={async (acceptedFiles) => {
                      ...
                      let res: string = await uploadToCloudinary(
                        acceptedFiles[0],
                      );
                      setFormDetails({
                        ...formDetails,
                      ...
                      >
                        ...
                        <>
                          ...
                          <Text color='blackAlpha.400' fontSize='xx-small'>
                            (Recommended size: 420x187 | JPG, PNG | Max size:
                            2MB)
                          </Text>
                        </>
                      </Flex>
            ...
            <FormControl _focusWithin={{ borderBottomColor: 'gray.300' }}>
              ...
              <Flex alignItems='end' experimental_spaceX='4' w='full'>
                ...
                >
                  ...
                  >
                    {[
                      formDetails.slides[0] ? formDetails.slides[0] : 0,
                      formDetails.slides[1] ? formDetails.slides[1] : 0,
