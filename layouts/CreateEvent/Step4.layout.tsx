    ...
    <>
      {wallet.address && (
        <form
          onSubmit={(e) => {
            e.preventDefault();
            onSubmit(encryptLink(_link), venue === 'Huddle', venueXY);
          }}
        >
                ...
                >
                  ...
                  <Menu>
                    ...
                    <MenuList
                      ...
                      zIndex={9}
                    >
                      <MenuItem onClick={() => setVenue('Huddle')}>
                        Huddle01
                      </MenuItem>
                      <MenuItem onClick={() => setVenue('Self Hosted')}>
                        Self Hosted
                      </MenuItem>
                      <MenuItem onClick={() => setVenue('In Person')}>
                        In Person
                      </MenuItem>
                    </MenuList>
                  </Menu>
