        ...
        <form
          onSubmit={(e) => {
            ...
            onSubmit(
              `${startDateTime
                .tz('UTC')
                .format('YYYY:MM:DDTHH:mm:ss')}-${`${endHours}`.padStart(
                2,
                '0',
          ...
          <ModalBody>
            <FormControl isRequired>
              ...
              <Input
                ...
                onChange={(e) => {
                  setStartDateTime(moment.tz(e.target.value, tz.value || tz));
                }}
                type='datetime-local'
              />
                ...
                <InputGroup size='md'>
                  <Input
                    onChange={(e) => {
                      setDuration((prev) => ({
                        ...prev,
                        hours: !isNaN(e.target.valueAsNumber)
                ...
                <InputGroup size='md'>
                  <Input
                    onChange={(e) => {
                      setDuration((prev) => ({
                        ...prev,
                        minutes: !isNaN(e.target.valueAsNumber)
                          ? e.target.valueAsNumber
                          : 0,
                      }));
                    }}
            ...
            <Text fontSize={'xs'} mt={2}>
              ...
              {`${endTimes.hh <= 12 ? endTimes.hh : endTimes.hh - 12}`.padStart(
                2,
                '0',
              )}
