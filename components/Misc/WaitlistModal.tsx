          ...
          >
            <Flex flexDir='column' justify='center' align='center'>
              ...
              >
                ...
                >
                  We&apos;re on the mission to revolutionize event ticketing
                  with blockchain, join the waitlist and lets band together on
                  this journey!
                </span>{' '}
                🚀
              </Text>
              <EmailBar email={email} setEmail={setEmail} onClose={onClose} />
            </Flex>
          </ModalBody>
        </ModalContent>
      </Modal>
