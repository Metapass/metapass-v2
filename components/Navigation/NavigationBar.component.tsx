...
export default function NavigationBar({ mode = 'dark' }) {
    ...
    let ramperAddress: any = null
    const { data } = useBalance({
        addressOrName: addy || ramperAddress,
    })
    ...
    const [ramper, setRamper] = useState<any>()
    const {
        isOpen: isOpen1,
        onOpen: onOpen1,
        onClose: onClose1,
    ...
    const handleRamper = async () => {
        onClose1()
        const signInResult = await signIn()
        console.log(signInResult)
        ramperAddress = signInResult.user?.wallets.ethereum.publicKey as string
        console.log(ramperAddress)
        if (ramperAddress) {
            setBalance(data?.formatted as string)
            setAddress(ramperAddress)
            setWallet({
                balance: data?.formatted as string,
                address: ramperAddress,
                type: 'ramper',
                chain: 'POLYGON',
                domain: null,
            })
    ...
    const mdcontent = [
        ...
        // {
        //     title: 'Social Login',
        //     description: 'Create a wallet using email / other social logins',
        //     icon: 'data:image/svg+xml;base64,',
        //     connector: handleRamper,
        // },
    ]
    useEffect(() => {
        if (isConnected) {
