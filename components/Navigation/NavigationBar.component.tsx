...
export default function NavigationBar({ mode = 'dark' }: Props) {
  ...
  useEffect(() => {
    if (isOpen1 && wallet.type) {
      const slug = wallet.type === 'sol' ? 'Solana Mainnet' : 'Polygon Mainnet';
      toast.success(`Make sure to choose ${slug}`, {
        icon: (
          <Avatar
            ...
            h='100%'
            w='15%'
            src={wallet.type === 'sol' ? 'assets/solana-logo.png' : polygon.img}
          />
        ),
        duration: 4000,
        position: 'bottom-center',
          ...
          {wallet.address ? (
            <Menu>
              <MenuButton
                ...
                as={Button}
              >
                <FaBars color={mode === 'white' ? 'black' : 'white'} />
              </MenuButton>{' '}
              <MenuList
                zIndex={999}
                display={{ base: 'block', md: 'none' }}
                  ...
                  <Flex experimental_spaceX='2' align='end'>
                    ...
                    <Box>
                      ...
                      >
                        ...
                        {wallet.chain === 'POLYGON' ? 'MATIC' : wallet.chain}
                      </Text>
                    </Box>
                  </Flex>
                </MenuItem>
            ...
            <>
              <Button
                ...
                fontWeight='normal'
                leftIcon={
                  isWalletLoading ? <Spinner size='sm' ml='2' /> : undefined
                }
                onClick={() => {
                  disconnectWallet();
                  onOpen3();
                ...
                <MenuButton
                  ...
                  leftIcon={
                    isWalletLoading ? (
                      ...
                      wallet.address && <BoringAva address={wallet.address} />
                    )
                  }
                    ...
                    <Flex experimental_spaceX='2' align='end'>
                      ...
                      <Box>
                        ...
                        <Text
                          ...
                          fontWeight='semibold'
                        >
                          {wallet.balance?.substring(0, 4)} {wallet.chain}
                        </Text>
                      </Box>
                    </Flex>
                  </MenuItem>
