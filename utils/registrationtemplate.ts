export const RegistrationTemplate = (
  ...
  const template = `<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional //EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml" xmlns:o="urn:schemas-microsoft-com:office:office" xmlns:v="urn:schemas-microsoft-com:vml" lang="en"><head>
      ...
      <base href="https://22515132.hubspotpreview-na1.com" target="_blank"><meta name="generator" content="HubSpot"><meta property="og:url" content="https://metapass-22515132.hubspotpagebuilder.com/-temporary-slug-b66fc437-7174-4134-9649-6d9988868671?hs_preview=sOnWATJS-82210694731"><meta name="robots" content="noindex,follow"><!--[if !((mso)|(IE))]><!-- --><style type="text/css">.moz-text-html .hse-column-container{max-width:600px !important;width:600px !important}
      ...
      <div id="hs_cos_wrapper_module-0-0-0" class="hs_cos_wrapper hs_cos_wrapper_widget hs_cos_wrapper_type_module" style="color: inherit; font-size: inherit; line-height: inherit;" data-hs-cos-general-type="widget" data-hs-cos-type="module"><!-- image_email.module - email-default-modules -->
      ...
      <tbody>
          <tr>
              <td align="center" valign="top" style="border-collapse:collapse; mso-line-height-rule:exactly; font-family:Arial, sans-serif; color:#23496d; word-break:break-word; text-align:center; padding:10px 20px; font-size:0px">
                  ...
                  <img alt="Twitter DP" src="https://22515132.fs1.hubspotusercontent-na1.net/hub/22515132/hubfs/Twitter%20DP.png?width=200&amp;upscale=true&amp;name=Twitter%20DP.png" style="outline:none; text-decoration:none; -ms-interpolation-mode:bicubic; max-width:100%; font-size:16px" width="100" align="middle">
      ...
      <pre>
      <table role="presentation" cellpadding="0" cellspacing="0" width="100%" style="border-spacing:0 !important; border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt"><tbody><tr><td class="hs_padded" style="border-collapse:collapse; mso-line-height-rule:exactly; font-family:Arial, sans-serif; font-size:15px; color:#23496d; word-break:break-word; padding:10px 20px"><div id="hs_cos_wrapper_module_16607278554572" class="hs_cos_wrapper hs_cos_wrapper_widget hs_cos_wrapper_type_module" style="color: inherit; font-size: inherit; line-height: inherit;" data-hs-cos-general-type="widget" data-hs-cos-type="module"><div id="hs_cos_wrapper_module_16607278554572_" class="hs_cos_wrapper hs_cos_wrapper_widget hs_cos_wrapper_type_rich_text" style="color: inherit; font-size: inherit; line-height: inherit;" data-hs-cos-general-type="widget" data-hs-cos-type="rich_text"><p style="mso-line-height-rule:exactly; font-size:18px; line-height:175%; font-weight:bold"><span style="color: #ea888d;">Your Approval is Pending for</span></p>
      <p style="mso-line-height-rule:exactly; font-size:18px; line-height:175%; font-weight:bold"><span style="color: #000000; font-size: 30px;">${title}</span></p>
      <p style="mso-line-height-rule:exactly; font-size:16px; line-height:175%; font-weight:normal"><span style="color: #e06666;">On ${date}</span></p>
      <p style="mso-line-height-rule:exactly; font-size:16px; line-height:175%; font-weight:normal"><span style="color: #e06666;"><br><span style="color: #000000;">${body}</span><br><br></span></p></div></div></td></tr></tbody></table>
      </pre>
      <table role="presentation" cellpadding="0" cellspacing="0" width="100%" style="border-spacing:0 !important; border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt"><tbody><tr><td class="hs_padded" style="border-collapse:collapse; mso-line-height-rule:exactly; font-family:Arial, sans-serif; font-size:15px; color:#23496d; word-break:break-word; padding:10px 20px"><div id="hs_cos_wrapper_module_16607280509103" class="hs_cos_wrapper hs_cos_wrapper_widget hs_cos_wrapper_type_module" style="color: inherit; font-size: inherit; line-height: inherit;" data-hs-cos-general-type="widget" data-hs-cos-type="module"><!-- raw_html_email.module - email-default-modules -->
      
      <a style="mso-line-height-rule:exactly; color:#737577; text-decoration:none" href="${maplink}" target="_blank" data-saferedirecturl="${maplink}" data-hs-link-id="0">View in Google Maps ↗</a></div></td></tr></tbody></table>
      <table role="presentation" cellpadding="0" cellspacing="0" width="100%" style="border-spacing:0 !important; border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt"><tbody><tr><td class="hs_padded" style="border-collapse:collapse; mso-line-height-rule:exactly; font-family:Arial, sans-serif; font-size:15px; color:#23496d; word-break:break-word; padding:20px 20px 10px"><div id="hs_cos_wrapper_module_16607284769814" class="hs_cos_wrapper hs_cos_wrapper_widget hs_cos_wrapper_type_module" style="color: inherit; font-size: inherit; line-height: inherit;" data-hs-cos-general-type="widget" data-hs-cos-type="module"><!-- button_email.module - email-default-modules -->
      ...
      <tbody><tr>
          <!--[if mso]>
        <td align="center" valign="middle" bgcolor="#AD62D2" role="presentation"  valign="middle" style="border-radius:8px;cursor:auto;background-color:#AD62D2;padding:12px 18px;">
      <![endif]-->
      <!--[if !mso]><!-- -->
        <td align="center" valign="middle" bgcolor="#AD62D2" role="presentation" style="border-collapse:collapse; mso-line-height-rule:exactly; font-family:Arial, sans-serif; font-size:15px; color:#23496d; word-break:break-word; border-radius:8px; cursor:auto; background-color:#AD62D2">
      <!--<![endif]-->
          <a href="${eventpage}" target="_blank" style="color:#00a4bd; mso-line-height-rule:exactly; font-size:16px; font-family:Arial, sans-serif; Margin:0; text-transform:none; text-decoration:none; padding:12px 18px; display:block" data-hs-link-id="0">
            <strong style="color:#ffffff;font-weight:normal;text-decoration:none;font-style:normal;">Open Event Page</strong>
          </a>
        </td>
      </tr>
      </tbody></table>
      </div></td></tr></tbody></table>
      <div id="hs_cos_wrapper_module-2-0-0" class="hs_cos_wrapper hs_cos_wrapper_widget hs_cos_wrapper_type_module" style="color: inherit; font-size: inherit; line-height: inherit;" data-hs-cos-general-type="widget" data-hs-cos-type="module"><!-- email_footer.module - email-default-modules -->
      ...
      <!--[if !((mso)|(IE))]><!-- -->
        <div class="hse-column-container" width="100%" style="min-width:280px; max-width:600px; width:100%; Margin-left:auto; Margin-right:auto; border-collapse:collapse; border-spacing:0; padding-bottom:20px; padding-top:20px">
      <!--<![endif]-->
      <!--[if (mso)|(IE)]>
        <div class="hse-column-container" style="min-width:280px;max-width:600px;width:100%;border-collapse:collapse;border-spacing:0;">
